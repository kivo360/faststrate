...
```sh
uvx copier copy gh:kivo360/faststrate .
```
...
1. In your project repository, run:
    ...
    uvx copier copy --overwrite --exclude src/ --exclude tests/ gh:kivo360/faststrate .
    ```
...
1. ⭐️ _GitHub Codespaces_: click on [Open in GitHub Codespaces](https://github.com/codespaces/new/kivo360/faststrate) to start developing in your browser.
2. ⭐️ _VS Code Dev Container (with container volume)_: click on [Open in Dev Containers](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/kivo360/faststrate) to clone this repository in a container volume and create a Dev Container with VS Code.
